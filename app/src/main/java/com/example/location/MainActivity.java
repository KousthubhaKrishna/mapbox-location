...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback, LocationEngineListener, PermissionsListener , MapboxMap.OnMapClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //My default position Code
//        Intent in = getIntent();
//        double lat = Double.parseDouble(in.getStringExtra("latitude"));
//        double lon = Double.parseDouble(in.getStringExtra("longitude"));
//        point = new LatLng();
...
//        point.setLongitude(lon);
    ...
    public void defaultRoute(LatLng point){
